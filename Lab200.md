...
이미 생성 경험이 있는 경우는 오른쪽 위의 **+ button** 클릭한 뒤  **Add application**를 클릭한다.<br>
...
2. **Workflows** 탭을 이동합니다. 워크플로우는 Git commit에 의해 기동(trigger)되며, 현재는 기본 생성된 **build** 만이 Pipeline에 등록되어 있고 실행시 처음 시작되도록 Workflow의 제일 처음에 있습니다.
