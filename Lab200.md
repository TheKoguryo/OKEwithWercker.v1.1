...
Wercker를 사용하기 위해 필요한 설정 파일로 Wercker에서 소스 애플리케이션을 빌드, 배포하는 과정에서 필요한 모든 step 들을 정의합니다.

1. GitHub으로 접속하여, **twitter-feed** 레포지토리에서 **Create new file** 클릭
  ![](images/100/13.png)

2. **Name your file...** 에 `wercker.yml` 입력
  ![](images/100/14.png)

3. **Edit new file** 에 다음 yaml 파일을 **붙여넣기**합니다.
    ```yaml
...
4. 에디터 창에 아래와 같은 YAML 파일을 볼 수 있습니다.
...
6. 화면의 제일 밑에 **Commit new file** 버튼을 클릭하여 파일 추가를 완료합니다.
